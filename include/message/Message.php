                    ...
                    foreach ($replies as $reply) {
                        ...
                        if ($reply['userid']) {
                            ...
                            if (!$lastreplies) {
                                ...
                                $sql = "SELECT DISTINCT m1.* FROM chat_messages m1 LEFT JOIN chat_messages m2 ON (m1.chatid = m2.chatid AND m1.id < m2.id) WHERE m2.id IS NULL AND m1.chatid IN (" . implode(',', $chatids) . ") AND reviewrequired = 0;";
