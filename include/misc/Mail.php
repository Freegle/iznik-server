...
class Mail {
    ...
    const RETURNPATH_THRESHOLDS = [
        ...
        Mail::RELEVANT => 0,
        Mail::RELEVANT_OFF => 10,
        Mail::VOLUNTEERING => 10,
        Mail::VOLUNTEERING_OFF => 10,
        Mail::VOLUNTEERING_RENEW => 10,
        Mail::NEWSFEED => 10,
        Mail::NEWSFEED_OFF => 0,
        ...
        Mail::REQUEST => 10,
        Mail::REQUEST_COMPLETED => 10,
        Mail::STORY => 10,
        Mail::STORY_OFF => 0,
        Mail::STORY_ASK => 0,
        Mail::WELCOME => 10,
        Mail::FORGOT_PASSWORD => 10,
        Mail::VERIFY_EMAIL => 10,
        Mail::BAD_SMS => 0,
        Mail::SPAM_WARNING => 0
    ];
