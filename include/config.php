...
if (!defined('IZNIK_BASE')) {
    ...
    spl_autoload_register(function ($class_name) {
        ...
        foreach ([ '/include/', '/include/user/', '/include/session/', '/include/group/', '/include/message/', '/include/misc/', '/include/chat/', '/include/newsfeed/', '/include/spam/', '/include/config/', '/include/dashboard/', '/include/mail/', '/include/noticeboard/', '/include/integrations/', '/test/ut/' ] as $dir) {
