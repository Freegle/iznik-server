...
#        error_log("Create at $lat, $lng");
        ...
        if ($lat || $lng ||
            ...
            $pos = ($lat || $lng) ? "ST_GeomFromText('POINT($lng $lat)', {$this->dbhr->SRID()})" : "ST_GeomFromText('POINT(-2.5209 53.9450)', {$this->dbhr->SRID()})";
