...
class sessionTest extends IznikAPITestCase
{
    ...
    public function testSubMailCOVID() {
        putenv('UTTESTCOVIDCONFIRM=1');
        ...
        # Mail - goes to system as not confirmed COVID yet.
        ...
        $r = new MailRouter($this->dbhr, $this->dbhm);
        $id = $r->received(Message::EMAIL, 'test@test.com', 'testgroup@' . GROUP_DOMAIN, $msg, $gid);
        ...
        # Should have routed message to Pending now.
        ...
        # Now confirm COVID for the sender - should process the chat.
        $_SESSION['id'] = $uid2;
        $ret = $this->call('session', 'POST', [
            'covidconfirmed' => TRUE,
            'msgid' => $id
