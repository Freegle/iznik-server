...
class commentAPITest extends IznikAPITestCase {
    ...
    protected function setUp() : void {
        ...
        list($g2, $this->groupid2) = $this->createTestGroup('testgroup2', Group::GROUP_REUSE);
        list($this->user, $this->uid, $emailid) = $this->createTestUserWithMembershipAndLogin($this->groupid, User::ROLE_OWNER, NULL, NULL, 'Test User', 'test@test.com', 'testpw');

        list($this->user2, $this->uid2, $emailid2) = $this->createTestUser(NULL, NULL, 'Test User', 'test2@test.com', 'testpw2');
    }
