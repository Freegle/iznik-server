...
//        $this->dbhr->errorLog = TRUE;
    ...
    public function testEditAsMod()
    {
        ...
        # Check edit history
        $this->assertEquals('Test edit long', $ret['message']['edits'][2]['oldsubject']);
        $this->assertEquals('OFFER: Test item (TV1)', $ret['message']['edits'][2]['newsubject']);
        $this->assertEquals(Message::TYPE_OTHER, $ret['message']['edits'][2]['oldtype']);
        $this->assertEquals(Message::TYPE_OFFER, $ret['message']['edits'][2]['newtype']);
        $this->assertEquals('Hey.', $ret['message']['edits'][1]['oldtext']);
        $this->assertEquals('Test edit', $ret['message']['edits'][1]['newtext']);
    }
