...
class groupTest extends IznikTestCase
{
    ...
    public function testWelcomeReview()
    {
        ...
        list($u, $uid, $emailid) = $this->createTestUser(null, null, 'Test User', NULL, 'testpw');
    ...
    public function testGetModsWithAddedAt() {
        ...
        // Note: getMods returns integers, but createTestUser returns string IDs
        $allMods = $g->getMods();
    ...
    public function testGetModsAddedAtParameterBinding() {
        ...
        $this->assertContains((int)$uid1, $owners);
    }
}
