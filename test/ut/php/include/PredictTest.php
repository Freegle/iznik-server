...
class PredictTest extends IznikTestCase {
    ...
    public function testBasic() {
        ...
        $this->log("Predict good user {$goodusers[0]}");
        assertEquals(User::RATING_UP, $p->predict($goodusers[0]));
        $this->log("Predict bad user {$badusers[0]}");
