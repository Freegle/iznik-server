...
abstract class IznikAPITestCase extends IznikTestCase {
    ...
    protected function setUp() {
        ...
        $dbhm->preExec("DELETE users, users_emails FROM users INNER JOIN users_emails ON users.id = users_emails.userid WHERE users_emails.email IN ('test@test.com', 'test2@test.com', 'tes2t@test.com');");
